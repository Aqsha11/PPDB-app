<x-app-layout>
    <x-slot name="header">Tambah Tahapan</x-slot>
    ...
    <div class="space-y-6">
        ...
        <x-admin.module-header title="Tambah Tahapan" description="Buat tahapan pendaftaran PPDB baru.">
            <x-slot name="icon">
                ...
                <div class="space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <x-text-input type="text" id="judul" name="judul" :value="old('judul')" class="mt-1" placeholder="Nama tahapan" required />
                            <x-input-error :messages="$errors->get('judul')" class="mt-1.5" />
                        </div>

                        <div>
                            <x-input-label for="urutan" value="Urutan" />
                            <x-text-input type="number" id="urutan" name="urutan" :value="old('urutan')" class="mt-1" min="1" placeholder="Nomor urut" required />
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="4" class="mt-1 block w-full rounded-lg border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white focus:border-blue-500 focus:ring-blue-500 text-sm transition-colors" placeholder="Deskripsi tahapan">{{ old('deskripsi') }}</textarea>
