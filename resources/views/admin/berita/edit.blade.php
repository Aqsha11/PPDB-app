<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <x-card>
            <form action="{{ route('admin.berita.update', $data->id) }}" method="POST" enctype="multipart/form-data" x-data="formValidation()">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <x-text-input type="text" id="judul" name="judul" :value="old('judul', $data->judul)" class="mt-1" placeholder="Masukkan judul berita..." required maxlength="255" />
                    ...
                    <div>
                        ...
                        <x-text-input type="text" id="penulis" name="penulis" :value="old('penulis', $data->penulis)" class="mt-1" placeholder="Masukkan nama penulis..." maxlength="255" />
