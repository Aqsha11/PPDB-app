<x-app-layout>
    <x-slot name="header">Detail Jalur Pendaftaran</x-slot>
    ...
    <div class="space-y-6">
        ...
        <x-card>
            <div class="space-y-4">
                <div>
                    <span class="text-sm font-medium text-gray-500">Nama Jalur</span>
                    <p class="mt-1 text-sm text-gray-900">{{ $data->nama_jalur }}</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-900">{{ $data->kuota }}</p>
                </div>
            ...
            <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-gray-100">
                ...
                <a href="{{ route('admin.jalur.edit', $data->id) }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    Edit
                </a>
            </div>
        </x-card>
