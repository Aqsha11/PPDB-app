            ...
            <form action="{{ route('admin.tahun-ajaran.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" id="tahun_awal" name="tahun_awal" value="{{ old('tahun_awal') }}" min="2000" max="2099" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Contoh: 2025" required />
                        <x-input-error :messages="$errors->get('tahun_awal')" class="mt-1" />
                    </div>

                    <div>
                        <x-input-label for="tahun_akhir" value="Tahun Akhir" />
                        <input type="number" id="tahun_akhir" name="tahun_akhir" value="{{ old('tahun_akhir') }}" min="2000" max="2099" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Contoh: 2026" required />
